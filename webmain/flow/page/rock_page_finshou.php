...
$(document).ready(function(){
	{params}
	var modenum = 'finshou',modename='收票',isflow=3,modeid='106',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"inorout","name":"\u6536\u7968","fieldstype":"radio","ispx":"0","isalign":"0","islb":"0"},{"fields":"type","name":"\u7c7b\u578b","fieldstype":"fixed","ispx":"0","isalign":"0","islb":"0"},{"fields":"name","name":"\u6536\u7968\u540d\u79f0","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"money","name":"\u6536\u7968\u91d1\u989d","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"paydt","name":"\u6536\u7968\u65e5\u671f","fieldstype":"date","ispx":"0","isalign":"0","islb":"1"},{"fields":"fullname","name":"\u516c\u53f8\u5355\u4f4d\u540d\u79f0","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"custid","name":"\u5bf9\u5e94\u5ba2\u6237ID","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"0"},{"fields":"address","name":"\u516c\u53f8\u5730\u5740","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"tel","name":"\u8054\u7cfb\u7535\u8bdd","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"shibieid","name":"\u7eb3\u7a0e\u8bc6\u522b\u53f7","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"openbank","name":"\u5f00\u6237\u884c","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"cardid","name":"\u5f00\u6237\u5e10\u53f7","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"paytype","name":"\u5f00\u7968\u7c7b\u578b","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"num","name":"\u5173\u8054\u5408\u540c","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_finshou|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistfinshou = a;
			addtabs({num:'daorufinshou',url:'flow,input,daoru,modenum=finshou',icons:'plus',name:'导入收票'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"收票名称",dataIndex:"name"},{text:"收票金额",dataIndex:"money"},{text:"收票日期",dataIndex:"paydt"},{text:"公司单位名称",dataIndex:"fullname"},{text:"纳税识别号",dataIndex:"shibieid"},{text:"开票类型",dataIndex:"paytype"},{text:"关联合同",dataIndex:"num"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewfinshou_{rand}').bootstable(bootparams);
	c.init();
