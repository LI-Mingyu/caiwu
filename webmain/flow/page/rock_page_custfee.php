...
$(document).ready(function(){
	{params}
	var modenum = 'custfee',modename='费用单',isflow=3,modeid='98',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"htnum","name":"\u81ea\u52a8\u7f16\u53f7","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"createname","name":"\u62a5\u9500\u4eba","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"1"},{"fields":"paydt","name":"\u4ed8\u8d39\u65e5\u671f","fieldstype":"datetime","ispx":"0","isalign":"0","islb":"1"},{"fields":"custid","name":"\u5ba2\u6237id","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"1"},{"fields":"depart","name":"\u90e8\u95e8","fieldstype":"changedept","ispx":"0","isalign":"0","islb":"1"},{"fields":"paymtd","name":"\u4ed8\u6b3e\u65b9\u5f0f","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"optname","name":"\u7ecf\u529e\u4eba","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"1"},{"fields":"accid","name":"\u4ed8\u6b3e\u8d26\u6237","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"type","name":"\u8d39\u7528\u7c7b\u578b","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"money","name":"\u4ed8\u6b3e\u91d1\u989d","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"htid","name":"\u5408\u540cID","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"1"},{"fields":"custname","name":"\u5ba2\u6237\u540d\u5b57","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_custfee|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistcustfee = a;
			addtabs({num:'daorucustfee',url:'flow,input,daoru,modenum=custfee',icons:'plus',name:'导入费用单'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('Y3VzdGZlZQ::'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"自动编号",dataIndex:"htnum"},{text:"报销人",dataIndex:"createname"},{text:"付费日期",dataIndex:"paydt"},{text:"客户id",dataIndex:"custid"},{text:"部门",dataIndex:"depart"},{text:"付款方式",dataIndex:"paymtd"},{text:"经办人",dataIndex:"optname"},{text:"付款账户",dataIndex:"accid"},{text:"费用类型",dataIndex:"type"},{text:"说明",dataIndex:"explain"},{text:"付款金额",dataIndex:"money"},{text:"合同ID",dataIndex:"htid"},{text:"客户名字",dataIndex:"custname"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewcustfee_{rand}').bootstable(bootparams);
	c.init();
