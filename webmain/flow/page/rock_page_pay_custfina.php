<?php
/**
*	模块：pay_custfina.合同付款单
*	说明：自定义区域内可写你想要的代码
*	来源：流程模块→表单元素管理→[模块.合同付款单]→生成列表页
*/
...
$(document).ready(function(){
	{params}
	var modenum = 'pay_custfina',modename='合同付款单',isflow=0,modeid='107',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"custname","name":"\u5ba2\u6237\u540d\u79f0","fieldstype":"selectdatafalse","ispx":"1","isalign":"0","islb":"1"},{"fields":"accid","name":"\u4ed8\u6b3e\u8d26\u6237","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"paytype","name":"\u4ed8\u6b3e\u7c7b\u578b","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"paymtd","name":"\u4ed8\u6b3e\u65b9\u5f0f","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"custid","name":"\u5ba2\u6237id","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"0"},{"fields":"depart","name":"\u90e8\u95e8\u540d\u79f0","fieldstype":"changedept","ispx":"0","isalign":"0","islb":"1"},{"fields":"htid","name":"\u5408\u540c","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"0"},{"fields":"htnum","name":"\u5408\u540c\/\u9500\u552e\u5355","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"dt","name":"\u6240\u5c5e\u65e5\u671f","fieldstype":"date","ispx":"0","isalign":"0","islb":"0"},{"fields":"qishu","name":"\u5bf9\u5e94\u7b2c\u51e0\u671f","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"type","name":"\u5408\u540c\u7c7b\u578b","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"money","name":"\u91d1\u989d","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"ispay","name":"\u662f\u5426\u4ed8\u6b3e","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"},{"fields":"paydt","name":"\u4ed8\u6b3e\u65f6\u95f4","fieldstype":"date","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"createname","name":"\u521b\u5efa\u4eba","fieldstype":"text","ispx":"1","isalign":"0","islb":"1"},{"fields":"optname","name":"\u7ecf\u529e\u4eba","fieldstype":"changeuser","ispx":"1","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_pay_custfina|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistpay_custfina = a;
			addtabs({num:'daorupay_custfina',url:'flow,input,daoru,modenum=pay_custfina',icons:'plus',name:'导入合同付款单'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"客户名称",dataIndex:"custname",sortable:true},{text:"付款账户",dataIndex:"accid"},{text:"付款类型",dataIndex:"paytype"},{text:"付款方式",dataIndex:"paymtd"},{text:"部门名称",dataIndex:"depart"},{text:"合同/销售单",dataIndex:"htnum"},{text:"对应第几期",dataIndex:"qishu"},{text:"合同类型",dataIndex:"type"},{text:"金额",dataIndex:"money",sortable:true},{text:"是否付款",dataIndex:"ispay",sortable:true},{text:"付款时间",dataIndex:"paydt"},{text:"说明",dataIndex:"explain"},{text:"创建人",dataIndex:"createname",sortable:true},{text:"经办人",dataIndex:"optname",sortable:true},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewpay_custfina_{rand}').bootstable(bootparams);
	c.init();
...
<div id="viewpay_custfina_{rand}"></div>
<!--HTMLend-->