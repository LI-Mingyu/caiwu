...
$(document).ready(function(){
	{params}
	var modenum = 'finhkd',modename='资金借入单',isflow=1,modeid='27',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"type","name":"\u7c7b\u578b","fieldstype":"fixed","ispx":"0","isalign":"0","islb":"0"},{"fields":"optname","name":"\u7ecf\u529e\u4eba","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"1"},{"fields":"temp_money","name":"\u9700\u8fd8\u6b3e\u91d1\u989d","fieldstype":"auto","ispx":"0","isalign":"0","islb":"0"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"moneycn","name":"\u8fd8\u6b3e\u91d1\u989d\u5927\u5199","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"money","name":"\u8fd8\u6b3e\u91d1\u989d","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"cardid","name":"\u6536\u6b3e\u5e10\u53f7","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"fullname","name":"\u4ed8\u6b3e\u4eba\u5168\u79f0","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"paytype","name":"\u6536\u6b3e\u65b9\u5f0f","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"applydt","name":"\u7533\u8bf7\u65e5\u671f","fieldstype":"text","ispx":"1","isalign":"0","islb":"1"},{"fields":"depart","name":"\u90e8\u95e8","fieldstype":"changedept","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		daoru:function(){
			...
			addtabs({num:'daorufinhkd',url:'flow,input,daoru,modenum=finhkd',icons:'plus',name:'导入资金借入单'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"经办人",dataIndex:"optname"},{text:"说明",dataIndex:"explain"},{text:"还款金额",dataIndex:"money",sortable:true},{text:"收款帐号",dataIndex:"cardid"},{text:"付款人全称",dataIndex:"fullname"},{text:"收款方式",dataIndex:"paytype"},{text:"申请日期",dataIndex:"applydt",sortable:true},{text:"部门",dataIndex:"depart"},{text:"状态",dataIndex:"statustext"},{
