...
$(document).ready(function(){
	{params}
	var modenum = 'finkemu',modename='会计科目',isflow=0,modeid='94',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"num","name":"\u7f16\u53f7","fieldstype":"text","ispx":"1","isalign":"0","islb":"1"},{"fields":"name","name":"\u540d\u79f0","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"type","name":"\u7c7b\u578b","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"},{"fields":"sort","name":"\u6392\u5e8f\u53f7","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"status","name":"\u72b6\u6001","fieldstype":"checkbox","ispx":"1","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_finkemu|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistfinkemu = a;
			addtabs({num:'daorufinkemu',url:'flow,input,daoru,modenum=finkemu',icons:'plus',name:'导入会计科目'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('Zmlua2VtdQ::'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"编号",dataIndex:"num",sortable:true},{text:"名称",dataIndex:"name"},{text:"类型",dataIndex:"type",sortable:true},{text:"排序号",dataIndex:"sort",sortable:true},{text:"状态",dataIndex:"status",sortable:true},{text:"说明",dataIndex:"explain"},{
...
$('#tdright_{rand}').prepend(c.getbtnstr('导入默认科目','daorumode')+'&nbsp;&nbsp;');
c.daorumode=function(){
	js.confirm('导入会覆盖你原来添加的哦，确定导入吗？', function(jg){
		if(jg=='yes')c.daorumodes();
	});
}
c.daorumodes=function(){
	js.loading('导入中...');
	js.ajax(this.getacturl('daorudev'),false, function(da){
		js.msgok('导入完成');
		a.reload();
	});
}
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewfinkemu_{rand}').bootstable(bootparams);
	c.init();
