...
$(document).ready(function(){
	{params}
	var modenum = 'feelv',modename='发票费率',isflow=0,modeid='102',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"fpname","name":"\u53d1\u7968\u540d\u79f0","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"felv","name":"\u5bf9\u5e94\u7684\u8d39\u7387","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_feelv|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistfeelv = a;
			addtabs({num:'daorufeelv',url:'flow,input,daoru,modenum=feelv',icons:'plus',name:'导入发票费率'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('ZmVlbHY:'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"发票名称",dataIndex:"fpname"},{text:"对应的费率",dataIndex:"felv"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewfeelv_{rand}').bootstable(bootparams);
	c.init();
