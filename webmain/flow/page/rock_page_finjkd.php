...
$(document).ready(function(){
	{params}
	var modenum = 'finjkd',modename='资金借出单',isflow=0,modeid='26',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"type","name":"\u5355\u636e\u7c7b\u578b","fieldstype":"fixed","ispx":"0","isalign":"0","islb":"0"},{"fields":"depart","name":"\u90e8\u95e8","fieldstype":"changedept","ispx":"0","isalign":"0","islb":"1"},{"fields":"optname","name":"\u64cd\u4f5c\u4eba","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"1"},{"fields":"applydt","name":"\u7533\u8bf7\u65e5\u671f","fieldstype":"text","ispx":"1","isalign":"0","islb":"1"},{"fields":"purpose","name":"\u501f\u6b3e\u7528\u9014","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"fullname","name":"\u6536\u6b3e\u4eba\u5168\u79f0","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"paytype","name":"\u4ed8\u6b3e\u65b9\u5f0f","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"0"},{"fields":"cardid","name":"\u6536\u6b3e\u5e10\u53f7","fieldstype":"select","ispx":"0","isalign":"0","islb":"0"},{"fields":"openbank","name":"\u5f00\u6237\u884c","fieldstype":"select","ispx":"0","isalign":"0","islb":"0"},{"fields":"money","name":"\u501f\u6b3e\u91d1\u989d","fieldstype":"text","ispx":"1","isalign":"0","islb":"1"},{"fields":"moneycn","name":"\u501f\u6b3e\u91d1\u989d\u5927\u5199","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		daoru:function(){
			...
			addtabs({num:'daorufinjkd',url:'flow,input,daoru,modenum=finjkd',icons:'plus',name:'导入资金借出单'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"部门",dataIndex:"depart"},{text:"操作人",dataIndex:"optname"},{text:"申请日期",dataIndex:"applydt",sortable:true},{text:"借款用途",dataIndex:"purpose"},{text:"收款人全称",dataIndex:"fullname"},{text:"借款金额",dataIndex:"money",sortable:true},{text:"说明",dataIndex:"explain"},{
