...
$(document).ready(function(){
	{params}
	var modenum = 'finjizhi',modename='记账支出',isflow=0,modeid='97',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"zhangid","name":"\u8d26\u5957","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"accountid","name":"\u5e10\u53f7","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"},{"fields":"applydt","name":"\u8bb0\u8d26\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"jtype","name":"\u652f\u51fa\u7c7b\u578b","fieldstype":"rockcombo","ispx":"1","isalign":"0","islb":"1"},{"fields":"money","name":"\u91d1\u989d","fieldstype":"number","ispx":"1","isalign":"2","islb":"1"},{"fields":"custname","name":"\u5bf9\u5e94\u5ba2\u6237","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"custid","name":"\u5bf9\u5e94\u5ba2\u6237Id","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"0"},{"fields":"xgname","name":"\u76f8\u5173\u4eba","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"1"},{"fields":"xgdeptname","name":"\u76f8\u5173\u90e8\u95e8","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"optname","name":"\u8bb0\u8d26\u4eba","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"optdt","name":"\u64cd\u4f5c\u65f6\u95f4","fieldstype":"datetime","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_finjizhi|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistfinjizhi = a;
			addtabs({num:'daorufinjizhi',url:'flow,input,daoru,modenum=finjizhi',icons:'plus',name:'导入记账支出'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('Zmluamlib29r'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"账套",dataIndex:"zhangid"},{text:"帐号",dataIndex:"accountid",sortable:true},{text:"记账日期",dataIndex:"applydt",sortable:true},{text:"支出类型",dataIndex:"jtype",sortable:true},{text:"金额",dataIndex:"money",sortable:true,align:"right"},{text:"对应客户",dataIndex:"custname"},{text:"相关人",dataIndex:"xgname"},{text:"相关部门",dataIndex:"xgdeptname"},{text:"说明",dataIndex:"explain"},{text:"记账人",dataIndex:"optname"},{
...
c.initpage=function(){
	$('#key_{rand}').parent().before('<td style="padding-right:10px;"><select style="width:130px"  class="form-control" id="zhangid_{rand}" ><option value="0">-所有账套-</option></select></td>');
	$('#key_{rand}').parent().before('<td style="padding-right:10px;"><select style="width:130px"  class="form-control" id="accountid_{rand}" ><option value="0">-所有帐号-</option></select></td>');
}
var loeb = false;
bootparams.loadbefore=function(d){
	if(!loeb){
		js.setselectdata(get('zhangid_{rand}'), d.zhangarr,'value');
		$('#zhangid_{rand}').change(function(){
			a.setparams({'zhangid':this.value}, true);
		});
		js.setselectdata(get('accountid_{rand}'), d.accountarr,'value');
		$('#accountid_{rand}').change(function(){
			a.setparams({'accountid':this.value}, true);
		});
		loeb=true;
	}
}
$('#tdright_{rand}').prepend(c.getbtnstr('批量记账','addpiliang')+'&nbsp;');
c.addpiliang=function(){
	addtabs({url:'flow,page,finjizhang,type=1,mobh='+modenum+'',num:'addpiliang1',name:'批量添加记账支出'});
}

//[自定义区域end]

	js.initbtn(c);
	var a = $('#viewfinjizhi_{rand}').bootstable(bootparams);
	c.init();
