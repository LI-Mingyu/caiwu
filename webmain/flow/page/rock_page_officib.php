...
$(document).ready(function(){
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"登记人",dataIndex:"base_name",sortable:true},{text:"登记人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"公文编号",dataIndex:"num"},{text:"来文日期",dataIndex:"laidt"},{text:"标题",dataIndex:"title"},{text:"来文单位",dataIndex:"unitsame"},{text:"接收单位",dataIndex:"unitname"},{text:"公文密级",dataIndex:"miji"},{text:"需要查阅",dataIndex:"recename"},{text:"状态",dataIndex:"statustext"},{
