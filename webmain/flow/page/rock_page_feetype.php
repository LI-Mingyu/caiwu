...
$(document).ready(function(){
	{params}
	var modenum = 'feetype',modename='费用类型',isflow=0,modeid='103',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"feename","name":"\u8d39\u7528\u540d\u5b57","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"seq","name":"\u6392\u5e8f","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_feetype|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistfeetype = a;
			addtabs({num:'daorufeetype',url:'flow,input,daoru,modenum=feetype',icons:'plus',name:'导入费用类型'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('ZmVldHlwZQ::'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"费用名字",dataIndex:"feename"},{text:"排序",dataIndex:"seq"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewfeetype_{rand}').bootstable(bootparams);
	c.init();
