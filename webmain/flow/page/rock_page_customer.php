...
$(document).ready(function(){
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"客户名称",dataIndex:"name"},{text:"所属人",dataIndex:"suoname"},{text:"客户类型",dataIndex:"type",sortable:true},{text:"来源",dataIndex:"laiyuan"},{text:"客户单位",dataIndex:"unitname"},{text:"是否标★",dataIndex:"isstat",sortable:true},{text:"合同数",dataIndex:"htshu",sortable:true},{text:"销售总额",dataIndex:"moneyz",sortable:true},{text:"待收金额",dataIndex:"moneyd",sortable:true},{text:"最后跟进",dataIndex:"lastdt",sortable:true},{
