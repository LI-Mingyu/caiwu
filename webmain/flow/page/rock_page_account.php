...
$(document).ready(function(){
	{params}
	var modenum = 'account',modename='账户维护',isflow=0,modeid='100',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"acc_name","name":"\u5f00\u6237\u540d","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"acc_num","name":"\u8d26\u53f7","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"bank","name":"\u5f00\u6237\u94f6\u884c","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"acc_type","name":"\u8d26\u6237\u5c5e\u6027","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"saving","name":"\u8d26\u6237\u4f59\u989d","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_account|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistaccount = a;
			addtabs({num:'daoruaccount',url:'flow,input,daoru,modenum=account',icons:'plus',name:'导入账户维护'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('YWNjb3VudA::'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"开户名",dataIndex:"acc_name"},{text:"账号",dataIndex:"acc_num"},{text:"开户银行",dataIndex:"bank"},{text:"账户属性",dataIndex:"acc_type"},{text:"账户余额",dataIndex:"saving"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewaccount_{rand}').bootstable(bootparams);
	c.init();
