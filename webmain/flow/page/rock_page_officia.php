...
$(document).ready(function(){
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"拟办人",dataIndex:"base_name",sortable:true},{text:"拟办人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"拟稿日期",dataIndex:"applydt"},{text:"公文编号",dataIndex:"num"},{text:"标题",dataIndex:"title"},{text:"主送单位",dataIndex:"unitname"},{text:"公文密级",dataIndex:"miji"},{text:"是否套红",dataIndex:"thid",sortable:true},{text:"盖章",dataIndex:"yzid",sortable:true},{text:"需要查阅",dataIndex:"recename"},{text:"状态",dataIndex:"statustext"},{
