...
$(document).ready(function(){
	{params}
	var modenum = 'finount',modename='财务帐号',isflow=0,modeid='95',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"name","name":"\u540d\u79f0","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"bankname","name":"\u5f00\u6237\u884c","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"banknum","name":"\u5e10\u53f7","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"bankming","name":"\u5f00\u6237\u540d","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"opendt","name":"\u5f00\u6237\u65e5\u671f","fieldstype":"date","ispx":"0","isalign":"0","islb":"1"},{"fields":"sort","name":"\u6392\u5e8f\u53f7","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"status","name":"\u72b6\u6001","fieldstype":"checkbox","ispx":"1","isalign":"0","islb":"1"},{"fields":"money","name":"\u5269\u4f59\u91d1\u989d","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_finount|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistfinount = a;
			addtabs({num:'daorufinount',url:'flow,input,daoru,modenum=finount',icons:'plus',name:'导入财务帐号'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('Zmlub3VudA::'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"名称",dataIndex:"name"},{text:"开户行",dataIndex:"bankname"},{text:"帐号",dataIndex:"banknum"},{text:"开户名",dataIndex:"bankming"},{text:"开户日期",dataIndex:"opendt"},{text:"排序号",dataIndex:"sort",sortable:true},{text:"状态",dataIndex:"status",sortable:true},{text:"剩余金额",dataIndex:"money",sortable:true},{
...
$('#tdright_{rand}').prepend(c.getbtnstr('更新金额','updatemoney')+'&nbsp;&nbsp;');
c.updatemoney=function(){
	js.loading('更新中...');
	js.ajax(this.getacturl('updatemoney'),false, function(da){
		js.msgok('更新完成');
		a.reload();
	});
}
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewfinount_{rand}').bootstable(bootparams);
	c.init();
