...
$(document).ready(function(){
	...
	var c = {
		...
		daoru:function(){
			...
			addtabs({num:'daorufinkai',url:'flow,input,daoru,modenum=finkai',icons:'plus',name:'导入开票/收票'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"开票/收票",dataIndex:"inorout"},{text:"开票名称",dataIndex:"name"},{text:"开票金额",dataIndex:"money"},{text:"开票日期",dataIndex:"paydt"},{text:"公司单位名称",dataIndex:"fullname"},{text:"纳税识别号",dataIndex:"shibieid"},{text:"开票类型",dataIndex:"paytype"},{
