...
$(document).ready(function(){
	{params}
	var modenum = 'custfinaa',modename='调账单',isflow=0,modeid='99',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"paydt","name":"\u8c03\u8d26\u65e5\u671f","fieldstype":"datetime","ispx":"0","isalign":"0","islb":"1"},{"fields":"tdnum","name":"\u8c03\u8d26\u5355\u7f16\u53f7","fieldstype":"num","ispx":"0","isalign":"0","islb":"1"},{"fields":"paytype","name":"\u8c03\u8d26\u7c7b\u578b","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"custid","name":"\u8c03\u8d26\u5355\u4f4did","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"optname","name":"\u7ecf\u529e\u4eba","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"1"},{"fields":"money","name":"\u8c03\u8d26\u91d1\u989d[*","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"type","name":"\u8c03\u8d26\u65b9\u5f0f","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"depart","name":"\u90e8\u95e8","fieldstype":"changedept","ispx":"0","isalign":"0","islb":"1"},{"fields":"htid","name":"\u5408\u540cID","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"1"},{"fields":"htnum","name":"\u5408\u540c\u7f16\u53f7","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"custname","name":"\u8c03\u8d26\u5355\u4f4d","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= {"columns_custfinaa_":"paydt,custid,explain,optname,money,type,depart,htnum,paytype,caozuo"};
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_custfinaa|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistcustfinaa = a;
			addtabs({num:'daorucustfinaa',url:'flow,input,daoru,modenum=custfinaa',icons:'plus',name:'导入调账单'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('Y3VzdGZpbmFh'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"调账日期",dataIndex:"paydt"},{text:"调账单编号",dataIndex:"tdnum"},{text:"调账类型",dataIndex:"paytype"},{text:"调账单位id",dataIndex:"custid"},{text:"说明",dataIndex:"explain"},{text:"经办人",dataIndex:"optname"},{text:"调账金额[*",dataIndex:"money"},{text:"调账方式",dataIndex:"type"},{text:"部门",dataIndex:"depart"},{text:"合同ID",dataIndex:"htid"},{text:"合同编号",dataIndex:"htnum"},{text:"调账单位",dataIndex:"custname"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewcustfinaa_{rand}').bootstable(bootparams);
	c.init();
...
<div id="viewcustfinaa_{rand}"></div>
<!--HTMLend-->