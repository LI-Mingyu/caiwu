...
//[管理员]在2020-05-20 13:01:51通过[系统→系统工具→系统设置]，保存修改了配置文件
return array(
	'url'	=> '',	//系统URL
	'localurl'	=> '',	//本地系统URL，用于服务器上浏览地址
	'title'	=> '一本账科技',	//系统默认标题
	'apptitle'	=> '一本账科技',	//APP上和手机网页版上的标题
	'db_host'	=> '127.0.0.1',	//数据库地址
	'db_user'	=> 'ybz',	//数据库用户名
	'db_pass'	=> 'Ybz58.com',	//数据库密码
	'db_base'	=> 'yibenzhang',	//数据库名称
	'db_engine'	=> 'MyISAM',
	'perfix'	=> 'xinhu_',	//数据库表名前缀
	'qom'	=> 'xinhu_',	//session、cookie前缀
	'highpass'	=> '',	//超级管理员密码，可用于登录任何帐号
	'db_drive'	=> 'mysqli',	//操作数据库驱动有mysql,mysqli,pdo三种
	'randkey'	=> 'xlrwbgmodzpatvjifuckheysnq',	//系统随机字符串密钥
	'asynkey'	=> '427b3dd05e5b460d8e50d5e93bf487a7',	//这是异步任务key
	'openkey'	=> '792262c875b67ec17c151d5a6a2615b1',	//对外接口openkey
	'updir'	=> 'upload',
	...
	'qqmapkey'	=> '',
	'xinhukey'	=> '739c068a5ae1b0f633964e15fc24bed2',	//中投官网key，用于在线升级使用
